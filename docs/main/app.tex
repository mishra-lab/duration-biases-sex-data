...
adjusted proportions (mean, \ci) for different variable value strata.  %SM: thiis part not super clear re: different variable value strata...
...
estimated under each partnership duration assumption outlined in \sref{meth.parts}. %SM: nice
\begin{table}[h]
  \centering
