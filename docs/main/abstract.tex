...
% LW: Unclear. by 'most important' do u mean otherwise
%     the bias will be greatest if left unadjusted?
% JK: Kind of -- it dependes on whether you're estimating
%     change rate (Q) or partner numbers (K) for long or short partnerships;
%     but for "mid-length" partnerships, the bias is unavoidable with crude estimates.
%     I've changed to "most useful", which may not be much better,
%     but we don't have words to get into these details here unfortunately.
\textbf{Conclusions.}
