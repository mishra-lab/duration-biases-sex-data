...
% SM: i think be a bit more specific - what other purposes?
% TODO
including analysis of individual-level data for conventional statistical models.
% SM: like what? empricial studies of...?
%     estimates of duration, given duration has been noted as a predictor of HIV/STI prevalence, incidence, etc.?
%     I think a few concrete examples might be helpful to strengthen the take-away from this amazing work! :)
% TODO
