...
\par
Quantitative estimates of sexual behaviour are required  %SM: I like the word "required" here - lets add to abstract/introduction (i.e. replace "key to")
...
less attention has been paid to biases associated with estimate-estimand mismatch  %SM: do we use estimate-estimand in the intro? i may have missed it sorry! but i agree with this approach re: biases associated with estimate-estimand mismatch :) 
(\eg numbers of partners in the past 30 days \vs partnership change rate).
\par
In this study, we explore precise interpretation of survey data to inform two key variables:  %SM: excellent paragraph
...
other estimates of intermittent risk exposure and event rates from cross-sectional surveys,  %SM: add this to the discussion/conclusion section of paper - is more concrete/precise re: the "so what re: broader applicability" examples than what we currently have :) 
