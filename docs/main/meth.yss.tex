...
$\bar{d} = \tilde{d}/\distr{log}{2}$ due to skewness.  %SM: nicely explained
To move beyond crude estimates, next we develop the generative model, %SM, maybe explain or reference "generative model" [to reach a more general epi audience]? (eg. "...to produce a representation or abstraction of the observed phenomena that could be calculated from the observations)...
...
% TODO: ^ move to discussion? %SM: agree with moving above to discussion [can cite Elizabeth's Kenya paper as an example and/or HM's CROI abstract - access gap paper not yet in preprint ugh].
...
a beta approximation of binomial (BAB) distribution (see Appendix~\ref{app.bab}) %SM: nice
...
%---------------------------------------------------------------------------------------------------
\paragraph{Measurement} %SM: love this!
Finally, individuals may not sell sex continuously (i.e. enter, exit, and re-enter periods/seasons of occupational risk"). % SM: optional edit - paranthesis example not needed but may want to relate back to the intro...see what you think
...
Respondents in \cite{Baral2014} were not asked whether they ever temporarily ceased selling sex, %SM: "cease" may be a better term than "stopped"?; and presuming this survey asked about temporarily cessastion of sex work?
but a later survey \cite{EswKP2014} indicated that $\phi = 45\%$ had stopped at least once. %SM: did they ask about duration of the periods in between engagement in sex work?
...
%---------------------------------------------------------------------------------------------------
\paragraph{Summary}
Figure~\ref{fig:model.yss} summarizes the proposed model graphically. %SM: very nice
...
We assume uninformative priors for these 3 parameters. %SM: :) 
